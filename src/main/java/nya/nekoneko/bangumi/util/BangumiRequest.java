...
public class BangumiRequest {
    ...
    public BangumiRequest url(String url) {
        builder.url(url);
        return this;
    }

    public BangumiRequest url(String url, Map<String, String> params) {
    ...
    public BangumiRequest get() {
        builder.get();
        return this;
    }

    public BangumiRequest postJson(String json) {
        RequestBody body = RequestBody.create(json, JSON);
        builder.post(body);
        return this;
    }

    public BangumiRequest postForm(Map<String, String> form) {
    ...
    public BangumiRequest uploadFile(InputStream inputStream, String fileName, Map<String, String> form) throws IOException {
...
//    public BangumiRequest cookie(BilibiliLoginInfo loginInfo) {
//        if (null != loginInfo) {
